...
def main():
    ...
    #path_ep_model = "./Co-zyBench/models/synthetic_large/10floors_V2.idf"
    #path_trajectories = "./Co-zyBench/models/synthetic_large/trajectories"
    path_profile = 18
    ...
    algorithms = ["majority"]
    cities = ["paris"]
    weather_file_mapping = {"mumbai": "./Co-zyBench/models/weathers/mumbai", "la": "./Co-zyBench/models/weathers/la",
                            "paris": "./Co-zyBench/models/weathers/paris", "scranton": "./Co-zyBench/models/weathers/scranton"}
        ...
        for city in cities:
            for algo in algorithms:
                for hvac_control_strategy in hvac_controller:
                    ...
                    idd_file = r"C:\Users\spili\Desktop\EnergyPlusV22-2-0\Energy+.idd"
                    ...
                    idf_origin.save("./Co-zyBench/models/temp/temp.idf")

                    idf = IDF("./Co-zyBench/models/temp/temp.idf")
                    ...
                    co_sim = CoSimulation("./Co-zyBench/models/temp/temp.idf", start_date, end_date, input_param, output_param, occupants.vote,
                    ...
                    result.save_result(start_date.strftime("%Y-%m-%d %H:%M"), city+"_"+algo+"_"+str(hvac_control_strategy)+"_"+str(repeat_time), co_sim.total_people_count)
