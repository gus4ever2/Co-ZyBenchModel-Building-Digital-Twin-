...
import com.example.cozybench.model.validationRecords.loads.SteamEquipmentRecord;
...
@Component
public class SteamEquipmentFactory extends AbstractFactory<SteamEquipmentRecord> {

    public SteamEquipmentFactory() {
        super(LoadTypeEnum.STEAM_EQUIPMENT);
    }
    ...
    public Map<IdfObjectRecord, TypeEnumInterface> createFromProperties(Map<String, String> properties) {
        ...
        IdfObjectRecord record = SteamEquipmentRecord.builder()
        ...
        records.put(record, LoadTypeEnum.STEAM_EQUIPMENT);
