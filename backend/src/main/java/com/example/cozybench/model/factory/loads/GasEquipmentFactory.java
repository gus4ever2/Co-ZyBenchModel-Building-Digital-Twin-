...
import com.example.cozybench.model.validationRecords.loads.GasEquipmentRecord;
...
@Component
public class GasEquipmentFactory extends AbstractFactory<GasEquipmentRecord> {

    public GasEquipmentFactory() {
        super(LoadTypeEnum.GAS_EQUIPMENT);
    }
    ...
    public Map<IdfObjectRecord, TypeEnumInterface> createFromProperties(Map<String, String> properties) {
        ...
        IdfObjectRecord record = GasEquipmentRecord.builder()
        ...
        records.put(record, LoadTypeEnum.GAS_EQUIPMENT);
